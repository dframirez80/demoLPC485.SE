...
void UART1_Init(uint32_t baudRate, uint8_t *buff_rx, uint8_t buff_rx_size){
    ...
    SWM_SetMovablePinSelect(SWM0, kSWM_USART1_TXD, kSWM_PortPin_P0_30);	    // USART0_TXD connect to P0_31
    SWM_SetMovablePinSelect(SWM0, kSWM_USART1_RXD, kSWM_PortPin_P0_31);		// USART0_RXD connect to P0_30
